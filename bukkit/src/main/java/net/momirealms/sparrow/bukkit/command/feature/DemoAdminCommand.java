...
public class DemoAdminCommand extends BukkitCommandFeature<CommandSender> {

    public DemoAdminCommand(SparrowCommandManager<CommandSender> sparrowCommandManager) {
    ...
    public Command.Builder<? extends CommandSender> assembleCommand(CommandManager<CommandSender> manager, Command.Builder<CommandSender> builder) {
        return builder
                ...
                .handler(commandContext -> {
                    ...
                    var pair = resolveSelector(selector, MessageConstants.COMMANDS_ADMIN_DEMO_SUCCESS_SINGLE, MessageConstants.COMMANDS_ADMIN_DEMO_SUCCESS_MULTIPLE);
