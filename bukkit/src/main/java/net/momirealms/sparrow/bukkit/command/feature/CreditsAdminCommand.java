        ...
        return builder
                ...
                .handler(commandContext -> {
                    ...
                    for (Player player : players) {
                        SparrowBukkitPlugin.getInstance().getNMSProxy().sendCredits(player);
                    }
                    if (!silent) {
                        if (players.size() == 1) {
                            SparrowBukkitPlugin.getInstance().getSenderFactory()
                                    ...
                                    .sendMessage(
                                            TranslationManager.render(
                                                    MessageConstants.COMMANDS_ADMIN_CREDITS_SUCCESS_SINGLE
                            ...
                            SparrowBukkitPlugin.getInstance().getSenderFactory()
                                    ...
                                    .sendMessage(
                                            TranslationManager.render(
                                                    MessageConstants.COMMANDS_ADMIN_CREDITS_SUCCESS_MULTIPLE
