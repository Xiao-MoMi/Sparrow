...
public class HealAdminCommand extends AbstractCommandFeature<CommandSender> {
                    ...
                    if (!silent) {
                        if (entities.size() == 1) {
                            SparrowBukkitPlugin.getInstance().getSenderFactory()
                                    ...
                                    .sendMessage(
                                            TranslationManager.render(
                                                    MessageConstants.COMMANDS_ADMIN_HEAL_SUCCESS_SINGLE
                            ...
                            SparrowBukkitPlugin.getInstance().getSenderFactory()
                                    ...
                                    .sendMessage(
                                            TranslationManager.render(
                                                    MessageConstants.COMMANDS_ADMIN_HEAL_SUCCESS_MULTIPLE
