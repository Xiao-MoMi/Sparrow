...
public class StoneCutterAdminCommand extends BukkitCommandFeature<CommandSender> {

    public StoneCutterAdminCommand(SparrowCommandManager<CommandSender> sparrowCommandManager) {
    ...
    public Command.Builder<? extends CommandSender> assembleCommand(CommandManager<CommandSender> manager, Command.Builder<CommandSender> builder) {
        return builder
                ...
                .handler(commandContext -> {
                    ...
                    var pair = resolveSelector(selector, MessageConstants.COMMANDS_ADMIN_STONE_CUTTER_SUCCESS_SINGLE, MessageConstants.COMMANDS_ADMIN_STONE_CUTTER_SUCCESS_MULTIPLE);
