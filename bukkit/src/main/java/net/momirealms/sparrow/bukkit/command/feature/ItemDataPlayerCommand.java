...
import net.momirealms.sparrow.common.util.MapUtils;
    ...
    public Command.Builder<? extends CommandSender> assembleCommand(CommandManager<CommandSender> manager, Command.Builder<CommandSender> builder) {
        return builder
                ...
                .handler(commandContext -> {
                    Map<String, Object> readableMap = ItemTagStream.INSTANCE.toReadableMap(commandContext.sender().getInventory().getItemInMainHand());
