...
public class GrindStoneAdminCommand extends MessagingCommandFeature<CommandSender> {
        ...
        return builder
                ...
                .handler(commandContext -> {
                    ...
                    CommandUtils.storeEntitySelectorMessage(commandContext, selector,
                            Pair.of(MessageConstants.COMMANDS_ADMIN_GRINDSTONE_SUCCESS_SINGLE, MessageConstants.COMMANDS_ADMIN_GRINDSTONE_SUCCESS_MULTIPLE)
                    );
                });
    }
}
