...
public class FlySpeedAdminCommand extends BukkitCommandFeature<CommandSender> {
    ...
    public FlySpeedAdminCommand(SparrowCommandManager<CommandSender> sparrowCommandManager) {
    ...
    public Command.Builder<? extends CommandSender> assembleCommand(CommandManager<CommandSender> manager, Command.Builder<CommandSender> builder) {
        return builder
                ...
                .handler(commandContext -> {
                    ...
                    var pair = resolveSelector(selector, MessageConstants.COMMANDS_ADMIN_FLY_SPEED_SUCCESS_SINGLE, MessageConstants.COMMANDS_ADMIN_FLY_SPEED_SUCCESS_MULTIPLE);
