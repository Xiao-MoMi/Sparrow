...
public class FlySpeedAdminCommand extends AbstractCommandFeature<CommandSender> {
                    ...
                    if (!silent) {
                        if (players.size() == 1) {
                            SparrowBukkitPlugin.getInstance().getSenderFactory()
                                    ...
                                    .sendMessage(
                                            TranslationManager.render(
                                                    MessageConstants.COMMANDS_ADMIN_FLY_SPEED_SUCCESS_SINGLE
                            ...
                            SparrowBukkitPlugin.getInstance().getSenderFactory()
                                    ...
                                    .sendMessage(
                                            TranslationManager.render(
                                                    MessageConstants.COMMANDS_ADMIN_FLY_SPEED_SUCCESS_MULTIPLE
