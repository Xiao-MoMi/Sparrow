...
public class SmithingTableAdminCommand extends BukkitCommandFeature<CommandSender> {

    public SmithingTableAdminCommand(SparrowCommandManager<CommandSender> sparrowCommandManager) {
        super(sparrowCommandManager);
    }

    @Override
    public String getFeatureID() {
        return "smithingtable_admin";
    }
    ...
    public Command.Builder<? extends CommandSender> assembleCommand(CommandManager<CommandSender> manager, Command.Builder<CommandSender> builder) {
        return builder
                ...
                .handler(commandContext -> {
                    ...
                    var pair = resolveSelector(selector, MessageConstants.COMMANDS_ADMIN_SMITHING_TABLE_SUCCESS_SINGLE, MessageConstants.COMMANDS_ADMIN_SMITHING_TABLE_SUCCESS_MULTIPLE);
