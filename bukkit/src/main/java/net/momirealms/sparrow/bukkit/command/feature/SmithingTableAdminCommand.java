...
public class SmithingTableAdminCommand extends MessagingCommandFeature<CommandSender> {
        ...
        return builder
                ...
                .handler(commandContext -> {
                    ...
                    CommandUtils.storeEntitySelectorMessage(commandContext, selector,
                            Pair.of(MessageConstants.COMMANDS_ADMIN_SMITHING_TABLE_SUCCESS_SINGLE, MessageConstants.COMMANDS_ADMIN_SMITHING_TABLE_SUCCESS_MULTIPLE)
                    );
                });
    }
}
