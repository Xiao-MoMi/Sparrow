...
public class LoomAdminCommand extends BukkitCommandFeature<CommandSender> {

    public LoomAdminCommand(SparrowCommandManager<CommandSender> sparrowCommandManager) {
    ...
    public Command.Builder<? extends CommandSender> assembleCommand(CommandManager<CommandSender> manager, Command.Builder<CommandSender> builder) {
        return builder
                ...
                .handler(commandContext -> {
                    ...
                    var pair = resolveSelector(selector, MessageConstants.COMMANDS_ADMIN_LOOM_SUCCESS_SINGLE, MessageConstants.COMMANDS_ADMIN_LOOM_SUCCESS_MULTIPLE);
