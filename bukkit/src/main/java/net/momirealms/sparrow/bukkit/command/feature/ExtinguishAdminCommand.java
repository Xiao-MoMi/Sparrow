...
public class ExtinguishAdminCommand extends MessagingCommandFeature<CommandSender> {
        ...
        return builder
                ...
                .handler(commandContext -> {
                    ...
                    CommandUtils.storeEntitySelectorMessage(commandContext, selector,
                            Pair.of(MessageConstants.COMMANDS_ADMIN_EXTINGUISH_SUCCESS_SINGLE, MessageConstants.COMMANDS_ADMIN_EXTINGUISH_SUCCESS_MULTIPLE)
                    );
                });
    }
}
