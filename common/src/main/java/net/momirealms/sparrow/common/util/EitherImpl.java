...
final class EitherImpl<U, V> implements Either<U, V> {
    ...
    private EitherImpl(java.util.Optional<? extends U> primary, java.util.Optional<? extends V> fallback) {
    ...
    public EitherImpl<U, V> withPrimary(java.util.Optional<? extends U> optional) {
    ...
    public EitherImpl<U, V> withFallback(java.util.Optional<? extends V> optional) {
    ...
    public static <U, V> EitherImpl<U, V> of(java.util.Optional<? extends U> primary, java.util.Optional<? extends V> fallback) {
