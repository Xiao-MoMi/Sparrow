...
public final class SparrowMetaKeys {
    public static final CloudKey<TranslatableComponent.Builder> PLAYER_SUCCESS_MESSAGE = CloudKey.of("player_success_message", TranslatableComponent.Builder.class);
