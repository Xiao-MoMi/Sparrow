...
public final class SparrowCaptionKeys {
    ...
    public static final Caption ARGUMENT_PARSE_FAILURE_UUID = Caption.of("argument.parse.failure.uuid");
    public static final Caption ARGUMENT_PARSE_FAILURE_SIGHT = Caption.of("argument.parse.failure.sight");
}
