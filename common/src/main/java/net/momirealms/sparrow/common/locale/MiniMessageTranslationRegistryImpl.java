...
public class MiniMessageTranslationRegistryImpl implements Examinable, MiniMessageTranslationRegistry {
    ...
    private final Map<String, MiniMessageTranslationRegistryImpl.Translation> translations = new ConcurrentHashMap<>();
    ...
    public void register(final @NotNull String key, final @NotNull Locale locale, final @NotNull String format) {
        this.translations.computeIfAbsent(key, MiniMessageTranslationRegistryImpl.Translation::new).register(locale, format);
    }
